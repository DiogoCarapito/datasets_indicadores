...
## Aumentar o limite de tamanho de ficheiros csv
maxInt = sys.maxsize
while True:
...
## Html do SDM com o bilhete de identidade do indicador
...
try:
    file = open("../data/scrapped_indicadores.csv", "r", encoding="utf-8")
...
for html_code in lista_codigo_html:
    ...
    rqst = requests.get(html, timeout=10)
...
df.to_csv("datasets/scrapped_indicadores.csv", index=False, header=False)
